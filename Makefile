...
SRC:=src/config.o8 src/math.o8 src/mem.o8 src/assert.o8 src/stack.o8 src/sprite_header.o8 src/screen_header.o8 src/state_header.o8 src/trampoline.o8  src/main.o8 src/states.o8 src/splash.o8 src/titlescreen.o8 src/charedit.o8 src/endscreen.o8 src/audio.o8 src/input.o8 src/ecs.o8 src/text.o8 src/screen.o8 src/font.o8 src/data.o8 src/sprite_data.o8 src/screen_data.o8 src/input_data.o8  
