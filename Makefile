...
FARDATA:=src/ui/font.o8 src/sprite_data.o8 src/data.o8 $(PREFABS) src/audio/sample_data.o8 src/input/input_data.o8 src/states/state_data.o8 src/initializers.o8 src/ui/screen_data.o8 src/renderer/rendererdata.o8 src/worldgen_data.o8
