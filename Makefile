...
SRC:=src/config.o8 src/math.o8 src/mem.o8 src/assert.o8 src/stack.o8 src/trampoline.o8 src/main.o8 src/audio.o8 src/input.o8 src/ecs.o8 src/dialog.o8 src/data.o8  src/input_data.o8 src/font.o8
